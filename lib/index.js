...
//TODO: How to add methods like each? librarian.each(function(files){
//
//});
// Librarian.prototype.extend = function(extension){
...
Librarian.prototype.run = unyield(function*(files, plugins){
    var ware = new Ware(plugins || this._plugins);
...
Librarian.prototype.read = unyield(function*(dir){
    ...
    try {
        ...
        var message = '[source] directory #dir# does not exist'.replace('#dir#', dir);
        message += '\n\n' + e.message;
...
Librarian.prototype.debugBuild = unyield(function*(files){
    ...
    yield fs.writeFile('lbr_debug.json', util.inspect(out, { showHidden: true, depth: null }));
